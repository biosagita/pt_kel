        ...
        <?php foreach($menu_sidebar as $key => $val) : ?>
            ...
            <?php if(!empty($val['child'])) : ?>
                <?php foreach($val['child'] as $key2 => $val2) : ?>
                    <li>
                        <a class="content_dashboard" data-url="<?php echo (!empty($val2['url_link']) ? $val2['url_link'] : '#'); ?>" href="<?php echo (!empty($val2['url_link']) ? $val2['url_link'] : '#'); ?>" title="<?php echo $val2['label']; ?>">
