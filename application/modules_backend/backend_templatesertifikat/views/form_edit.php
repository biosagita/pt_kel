    ...
    $(function() { "use strict";
        $('.wysiwyg-editor').summernote({
            ...
            onChange: function (contents, $editable)
            {
                ...
                $("#tpsr_template").val(contents[0]['innerHTML']);
            },
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <?php if($val['input_type'] == 'select') : ?>
                            <select name="<?php echo $val['db_field']; ?>" id="<?php echo $val['db_field']; ?>" <?php echo $val['input_attr']; ?> <?php echo (!empty($val['data_edit']['required']) ? $val['data_edit']['required'] : ''); ?> <?php echo (!empty($val['data_edit']['input_disabled']) ? $val['data_edit']['input_disabled'] : ''); ?>>
                        ...
                        <?php elseif($val['input_type'] == 'textarea') : ?>
                            <?php
                                /*
                                $arr_data = array(
                                    'nama_pemohon' => 'Keren Banget',
                                );
                                $val['data_edit']['input_value'] = parse_stringphp($val['data_edit']['input_value'], $arr_data);
                                */
                            ?>
                            ...
                            <script type="text/javascript">
                                $( 'textarea#<?php echo $val['db_field']; ?>' ).ckeditor();
                            </script>
                        <?php else : ?>
